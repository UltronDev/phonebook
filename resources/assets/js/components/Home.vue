    ...
    <div>
        <nav class="panel column is-offset-2 is-8">
            <p class="panel-heading">
                ...
                <button style="bottom: 5px;" class="button is-primary is-outlined pull-right" @click="openAdd"><i class="fa fa-plus"></i>
                </button>
            ...
            <a class="panel-block" v-for="item,key in temp">
                <span class="column is-9">
                    ...
                    <i class="has-text-danger fa fa-trash" aria-hidden="true" @click="destroy(key, item.id)"></i>
                </span>
                    <span class="panel-icon column is-1">
...
//                console.log(this.lists[new_key].name);
            },
            close() {
